/**
 * Regenerate Sofia with fresh audio - retry for better "ho ho ho"
 */
...
async function main() {
  ...
  console.log('REGENERATING SOFIA - FRESH AUDIO (RETRY)');
  console.log('='.repeat(70));
  ...
  console.log(`  ✓ Generated: santa_sofia.mp3 (${audioDuration.toFixed(1)}s)`);
  ...
  console.log('');
  console.log('='.repeat(70));
  console.log('✓ SOFIA COMPLETE (RETRY)');
  console.log('='.repeat(70));
