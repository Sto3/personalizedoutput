/**
 * Regenerate Elijah, Sofia, and Lily with fresh audio
 * - Fresh ElevenLabs generation for better "ho ho ho"
 * - Same settings as the perfect James/Emma
 * - Full audio (no cutoff)
 * - New CTA order
 */
...
async function createVideo(config) {
  ...
  console.log(`CREATING: ${config.childName} - ${config.hookText}`);
  console.log('='.repeat(70));
  ...
  console.log(`  ✓ Generated: santa_${config.name}.mp3 (${audioDuration.toFixed(1)}s)`);
...
async function main() {
  console.log('='.repeat(70));
  console.log('REGENERATING ELIJAH, SOFIA, LILY - FRESH AUDIO');
  console.log('='.repeat(70));
