/**
 * Regenerate ONLY Elijah and Lily with fresh audio + bright CTA
 * Trying to match Sofia's perfect voice quality
 * Emma, James, Sofia are LOCKED - do not touch
 */
...
async function createVideo(config) {
  ...
  console.log(`CREATING: ${config.childName} - matching Sofia quality`);
  console.log('='.repeat(70));
  ...
  console.log('  Same settings as Sofia: stability=0.68, similarity_boost=0.82, style=0.32');
  ...
  for (let frame = 0; frame < totalFrames; frame++) {
    ...
    switch (phase) {
      ...
      case 'cta':
        ...
        drawText(ctx, "Ready before Christmas \u{1F384}", 68, HEIGHT * 0.30, { color: '#FFD700' });
...
async function main() {
  console.log('='.repeat(70));
  console.log('REGENERATING ELIJAH & LILY ONLY');
  console.log('='.repeat(70));
  console.log('Trying to match Sofia\'s perfect voice quality');
  console.log('Emma, James, Sofia are LOCKED');
