...
const PRODUCT_CONTENT: Record<ProductType, ProductPageContent> = {
  ...
  flash_cards: {
    ...
    testimonials: [
      { name: 'Jennifer L.', location: 'Seattle, WA', quote: 'These cards made homework time something my son looks forward to. The Minecraft theme was perfect.', rating: 5 },
    ],
  ...
  vision_board: {
    ...
    testimonials: [
      { name: 'Amanda K.', location: 'Los Angeles, CA', quote: 'I see my board every morning and it genuinely motivates me. So much better than one I\'d make myself.', rating: 5 },
    ],
  ...
  santa_message: {
    ...
    testimonials: [
      { name: 'David & Lisa T.', location: 'Chicago, IL', quote: 'Our daughter\'s face when Santa mentioned her hamster by name... priceless. She\'s still talking about it.', rating: 5 },
      { name: 'Rachel M.', location: 'Boston, MA', quote: 'Better than any mall Santa experience. The personalization made it feel completely real.', rating: 5 },
    ],
  ...
  holiday_reset: {
    ...
    testimonials: [
      { name: 'Christine B.', location: 'Portland, OR', quote: 'First time I\'ve actually completed a year-end reflection. The personalization made it feel relevant, not generic.', rating: 5 },
    ],
  ...
  new_year_reset: {
    ...
    testimonials: [
      { name: 'James K.', location: 'Atlanta, GA', quote: 'Actually kept my resolutions for the first time ever. The personalized planning made all the difference.', rating: 5 },
    ],
  ...
  clarity_planner: {
    ...
    testimonials: [
      { name: 'Priya S.', location: 'San Francisco, CA', quote: 'Finally a planner that fits how I actually work. The personalization saved me from buying another generic system.', rating: 5 },
    ],
  ...
  thought_organizer: {
    ...
    testimonials: [
      { name: 'Marcus T.', location: 'New York, NY', quote: 'My anxiety about forgetting things is basically gone. This system just works because it was built for my brain.', rating: 5 },
    ],
