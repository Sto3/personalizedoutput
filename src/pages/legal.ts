  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <p><strong>All personalized content is created using artificial intelligence based on information you provide.</strong></p>
        <p>Our services utilize advanced AI technology, including:</p>
        <ul>
          <li><strong>Text Generation:</strong> Personalized scripts, lessons, and written content are generated by AI language models based on your inputs</li>
          <li><strong>Voice Synthesis:</strong> Audio content (including Santa messages and lesson narration) is created using AI text-to-speech technology</li>
          <li><strong>Image Generation:</strong> Vision boards and visual content may include AI-generated imagery</li>
        </ul>
        <p>While we strive for accuracy and quality, AI-generated content may occasionally contain errors or unexpected outputs. You are responsible for reviewing all content before sharing or using it.</p>
