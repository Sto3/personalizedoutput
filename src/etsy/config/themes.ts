...
export const WORKBOOK_THEMES: ThemeConfig[] = [
  // === Life Transitions ===
  {
    id: 'wb_post_breakup',
    productType: 'workbook',
    displayName: 'Post-Breakup Reflection Workbook',
    shortLabel: 'Post-breakup',
    category: 'life_transitions',
    audience: 'healing_adults',
    primaryKeywords: ['breakup workbook', 'breakup journal', 'post breakup healing', 'breakup reflection'],
    secondaryKeywords: ['moving on workbook', 'healing journal', 'relationship ending', 'breakup recovery'],
    emotionalAngles: ['healing', 'clarity', 'growth', 'processing', 'forward'],
    priceRange: { min: 9.95, max: 19.95, default: 14.95 }
  },
  {
    id: 'wb_divorce_rebuilding',
    productType: 'workbook',
    displayName: 'Divorce Rebuilding Workbook',
    shortLabel: 'Divorce rebuilding',
    category: 'life_transitions',
    audience: 'divorcing_adults',
    primaryKeywords: ['divorce workbook', 'divorce journal', 'divorce recovery', 'divorce reflection'],
  ...
  {
    id: 'wb_career_change_clarity',
    productType: 'workbook',
    displayName: 'Career Change Clarity Workbook',
    shortLabel: 'Career change',
    category: 'life_transitions',
    audience: 'career_changers',
    primaryKeywords: ['career change workbook', 'career clarity', 'job change journal', 'career transition'],
    secondaryKeywords: ['career planning', 'career reflection', 'new career', 'career goals workbook'],
  ...
  },
  {
    id: 'wb_new_job_reset',
    productType: 'workbook',
    displayName: 'New Job Reset Workbook',
    shortLabel: 'New job reset',
    category: 'life_transitions',
    audience: 'new_employees',
    primaryKeywords: ['new job workbook', 'job transition', 'new role journal', 'career start'],
  ...
  {
    id: 'wb_retirement_transition',
    productType: 'workbook',
    displayName: 'Retirement Transition Workbook',
    shortLabel: 'Retirement',
    category: 'life_transitions',
    audience: 'retiring_adults',
    primaryKeywords: ['retirement workbook', 'retirement journal', 'retirement planning', 'life after work'],
  ...
  {
    id: 'wb_moving_fresh_start',
    productType: 'workbook',
    displayName: 'Moving & Fresh Start Workbook',
    shortLabel: 'Moving fresh start',
    category: 'life_transitions',
    audience: 'relocating_adults',
    primaryKeywords: ['moving workbook', 'relocation journal', 'fresh start workbook', 'new city journal'],
  ...
  // === Personal Development ===
  {
    id: 'wb_goal_clarity',
    productType: 'workbook',
    displayName: 'Goal Clarity Workbook',
    shortLabel: 'Goal clarity',
    category: 'personal_development',
    audience: 'goal_setters',
    primaryKeywords: ['goal workbook', 'goal setting journal', 'goals clarity', 'goal planning'],
  ...
  {
    id: 'wb_decision_making',
    productType: 'workbook',
    displayName: 'Decision Making Workbook',
    shortLabel: 'Decision making',
    category: 'personal_development',
    audience: 'decision_makers',
    primaryKeywords: ['decision workbook', 'decision journal', 'making decisions', 'choice clarity'],
  ...
  {
    id: 'wb_values_discovery',
    productType: 'workbook',
    displayName: 'Values Discovery Workbook',
    shortLabel: 'Values discovery',
    category: 'personal_development',
    audience: 'self_explorers',
    primaryKeywords: ['values workbook', 'core values', 'values discovery', 'personal values'],
  ...
  {
    id: 'wb_purpose_calling',
    productType: 'workbook',
    displayName: 'Purpose & Calling Workbook',
    shortLabel: 'Purpose calling',
    category: 'personal_development',
    audience: 'purpose_seekers',
    primaryKeywords: ['purpose workbook', 'calling journal', 'life purpose', 'finding purpose'],
    secondaryKeywords: ['purpose discovery', 'meaning workbook', 'calling clarity', 'life meaning'],
    emotionalAngles: ['meaning', 'purpose', 'clarity', 'fulfillment', 'direction'],
    priceRange: { min: 9.95, max: 19.95, default: 14.95 }
  },
  {
    id: 'wb_confidence_building',
    productType: 'workbook',
    displayName: 'Confidence Building Workbook',
    shortLabel: 'Confidence building',
    category: 'personal_development',
    audience: 'confidence_seekers',
    primaryKeywords: ['confidence workbook', 'self confidence', 'building confidence', 'confidence journal'],
    secondaryKeywords: ['self belief', 'self esteem workbook', 'confidence growth', 'inner confidence'],
    emotionalAngles: ['confidence', 'strength', 'self-belief', 'growth', 'empowerment'],
    priceRange: { min: 9.95, max: 19.95, default: 14.95 }
  },
  {
    id: 'wb_time_priorities',
    productType: 'workbook',
    displayName: 'Time & Priorities Workbook',
    shortLabel: 'Time priorities',
    category: 'personal_development',
    audience: 'busy_adults',
    primaryKeywords: ['time management workbook', 'priorities workbook', 'time journal', 'productivity'],
    secondaryKeywords: ['time clarity', 'priority setting', 'time reflection', 'focus workbook'],
  ...
  // === Situational ===
  {
    id: 'wb_new_year_reset',
    productType: 'workbook',
    displayName: 'New Year Reset Workbook',
    shortLabel: 'New year reset',
    category: 'situational',
    audience: 'new_year_planners',
    primaryKeywords: ['new year workbook', 'new year journal', 'year reset', 'new year reflection'],
  ...
  {
    id: 'wb_birthday_reflection',
    productType: 'workbook',
    displayName: 'Birthday Reflection Workbook',
    shortLabel: 'Birthday reflection',
    category: 'situational',
    audience: 'birthday_celebrants',
    primaryKeywords: ['birthday workbook', 'birthday journal', 'birthday reflection', 'birthday intentions'],
  ...
  },
  {
    id: 'wb_annual_review',
    productType: 'workbook',
    displayName: 'Annual Review Workbook',
    shortLabel: 'Annual review',
    category: 'situational',
    audience: 'reflective_adults',
    primaryKeywords: ['annual review', 'year review workbook', 'yearly reflection', 'year in review'],
  ...
  {
    id: 'wb_relationship_check_in',
    productType: 'workbook',
    displayName: 'Relationship Check-In Workbook',
    shortLabel: 'Relationship check-in',
    category: 'situational',
    audience: 'couples',
    primaryKeywords: ['relationship workbook', 'couples journal', 'relationship check in', 'marriage workbook'],
  ...
  {
    id: 'wb_parenting_reflection',
    productType: 'workbook',
    displayName: 'Parenting Reflection Workbook',
    shortLabel: 'Parenting reflection',
    category: 'situational',
    audience: 'parents',
    primaryKeywords: ['parenting workbook', 'parenting journal', 'parent reflection', 'parenting goals'],
    secondaryKeywords: ['mom workbook', 'dad workbook', 'parenting clarity', 'family goals'],
  ...
  // === Faith-Based ===
  {
    id: 'wb_prayer_reflection',
    productType: 'workbook',
    displayName: 'Prayer & Reflection Workbook',
    shortLabel: 'Prayer reflection',
    category: 'faith_based',
    audience: 'faith_adults',
    primaryKeywords: ['prayer workbook', 'prayer journal', 'christian reflection', 'spiritual workbook'],
    secondaryKeywords: ['devotional workbook', 'faith journal', 'prayer reflection', 'quiet time'],
    emotionalAngles: ['faith', 'peace', 'surrender', 'connection', 'trust'],
    priceRange: { min: 9.95, max: 19.95, default: 14.95 }
  },
  {
    id: 'wb_spiritual_growth',
    productType: 'workbook',
    displayName: 'Spiritual Growth Workbook',
    shortLabel: 'Spiritual growth',
    category: 'faith_based',
    audience: 'spiritual_seekers',
    primaryKeywords: ['spiritual workbook', 'spiritual growth', 'faith workbook', 'soul journal'],
  ...
  {
    id: 'wb_gratitude_faith',
    productType: 'workbook',
    displayName: 'Gratitude & Faith Workbook',
    shortLabel: 'Gratitude faith',
    category: 'faith_based',
    audience: 'grateful_believers',
    primaryKeywords: ['gratitude workbook', 'gratitude journal', 'thankful workbook', 'blessings journal'],
  ...
  {
    id: 'wb_purpose_in_faith',
    productType: 'workbook',
    displayName: 'Purpose in Faith Workbook',
    shortLabel: 'Purpose in faith',
    category: 'faith_based',
    audience: 'purpose_seeking_believers',
    primaryKeywords: ['christian purpose', 'faith purpose', 'calling workbook', 'god purpose'],
