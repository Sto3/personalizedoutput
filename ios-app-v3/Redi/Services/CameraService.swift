...
class CameraService: NSObject, ObservableObject {
    ...
    private func setupCamera() {
        ...
        do {
            ...
            print("[CameraService] Camera setup error: \(error)")
        }
    }
    ...
    func startCapture() {
        ...
        processingQueue.async { [weak self] in
            ...
            DispatchQueue.main.async {
                self?.isRunning = true
                print("[CameraService] Capture started")
            }
        }
    }
    ...
    func stopCapture() {
        ...
        processingQueue.async { [weak self] in
            ...
            DispatchQueue.main.async {
                ...
                print("[CameraService] Capture stopped")
            }
        }
    }

    private func compressFrame(_ image: UIImage) -> Data? {
        // Resize to 512px max dimension (OpenAI recommendation for speed)
        let maxDimension: CGFloat = Config.Camera.maxDimension
        ...
        return resized?.jpegData(compressionQuality: Config.Camera.compressionQuality)
    }
}
